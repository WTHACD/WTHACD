...
My goal is to combine my experience in **networking/support** with my new skills in **software development** to contribute to organizations that value innovation, reliability, and growth.
...
- **Tools:** Git, Visual Studio Code, Microsoft Excel (Data Analysis).
...
- **Tech Stack:** HTML, CSS, JavaScript (Planned).

**Inventory Management System**
*Developing a flexible inventory solution for restaurants allowing custom recipe definitions and material explosions.*
- **Focus:** Database Design, Backend Logic.
